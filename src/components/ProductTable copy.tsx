            ...
            <div className="w-full md:w-[500px] mb-3">
                ...
                <table className="w-[350px] md:w-[500px] shadow">
                    <thead className="bg-white border border-gray-600 z-10">
                        <tr className="*:py-2 *:px-1 text-gray-600 *:md:text-sm *:text-[12px]">
                    ...
                    <tbody>
                        ...
                        .sort((a, b) => new Date(a.created_at).getTime() - new Date(b.created_at).getTime())
                        .map((task, index) => (
                            <tr key={task.id} className="border border-gray-300 hover:bg-gray-100 *:text-sm">
                                <td className="border border-gray-300 p-2 text-center">{firstItemIndex + index + 1}</td>
                                <td className="border border-gray-300 p-2 w-[100px] h-[100px] text-center">
                                    <img 
                                ...
                                <td className="border border-gray-300 p-2 text-center">{`${task.userId.slice(0, 4)}...`} </td>
                                ...
                                <td>
                                    ...
                                    <div className="flex flex-col">
                                        <Button 
                                            disabled={!userDetails?.username} /* userDetails?.username ? false : true */
